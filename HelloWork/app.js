...
function updateAppIcon() {
    ...
    if (iconElement) {
        ...
        // Salva in sessionStorage per mantenerla durante la sessione
        sessionStorage.setItem('currentIcon', newIcon);
    }
}
...
function loadAppIcon() {
    const iconElement = document.querySelector('.app-icon');
    if (iconElement) {
        // Carica icona salvata o generane una nuova
        const savedIcon = sessionStorage.getItem('currentIcon');
        if (savedIcon) {
